...
const Status = () => {
  return (
    ...
    <div className=" bg-gray-100 flex-wrap flex justify-center  sm:justify-around sm:ml-[252px] ">
      ...
      {/* title */}
      <div
        className="block bg-white  sm:w-[290px] sm:h-[456px] sm:ml-[21px] sm:mr-[24px]  sm:mt-[19px] 
      ...
      {/* Sales Statistics */}
      <div
        className="block bg-white sm:w-[290px] sm:h-[476px] sm:mt-[19px]
    ...
    `}
          ...
          <table class="min-w-full text-left text-sm font-light">
            <tbody className="">
              {/* 1 */}
              <tr class="border-b dark:border-neutral-500">
                <td class="whitespace-nowrap  py-3  flex justify-center items-center font-medium">
                  <img
