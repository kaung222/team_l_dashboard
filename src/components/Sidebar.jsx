    ...
    className=' text-black'>
      ...
      <div className="">
        ...
        <Link to={'/'}>
          ...
          <button onClick={() => setSidebarOpen(false)} className=" text-black text-3xl font-bold">
           <RiMenu2Line />
          </button>
        </div>
    {/* User Dropdown */}
      ...
      <div className="">
        ...
        <div className="">
          ...
          <div className=" flex justify-between items-center px-7 mb-">
            ...
            <span className=' text-2xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><rect width="20" height="15" x="2" y="3" rx="3" className='' fill='#000000'></rect><path d="M16,21H8a.99992.99992,0,0,1-.832-1.55469l4-6a1.03785,1.03785,0,0,1,1.66406,0l4,6A.99992.99992,0,0,1,16,21Z" fill='white'></path></svg></span>
            <h1 className=' text-black text-[18px]'>Dashboard</h1>
            </a>
            <span className=' badge bg-black text-white font-bold mt-3'>3</span>
          </div>
            {/* App */}
              ...
              <ul className='text-[18px]'>
                <li className='collapse'>
                  ...
                  <div className=" collapse-title flex justify-between">
                    ...
                    <span className=' mt-1 text-stone-600 mr-10'><BsChevronDown /> </span>
                  </div>
       ...
       <div className="">
        ...
        <div className="collapse">
            ...
            <div className="collapse-title ">
                <div className=" flex justify-between items-center px-3 w-[300px]">
                <a href="/" className=' flex items-center'>
                <span className=' text-xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><path fill='white' d="M21,12c0-.34-.02-.67-.05-1H12.5V9.5a.99991.99991,0,0,0-1.707-.707l-2.5,2.5a.99962.99962,0,0,0,0,1.41406l2.5,2.5A.99991.99991,0,0,0,12.5,14.5V13h8.45C20.98,12.67,21,12.34,21,12Z"></path><path fill='#000000' d="M12.5,13v1.5a.99989.99989,0,0,1-1.707.707l-2.5-2.5a.99962.99962,0,0,1,0-1.41406l2.5-2.5A.99991.99991,0,0,1,12.5,9.5V11h8.44952a10,10,0,1,0,0,2Z"></path></svg></span>
      ...
      <div className=" flex justify-between items-center px-7 mt-3">
            <a href="/" className=' flex items-center mt-2'>
            <span className=' text-2xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><path  fill='#000000' d="M21 8H13a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2zM21 12H13a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2z"></path><rect width="8" height="8" x="2" y="4"  fill='white' rx="1"></rect><path  fill='#' d="M21 16H3a1 1 0 0 1 0-2H21a1 1 0 0 1 0 2zM13 20H3a1 1 0 0 1 0-2H13a1 1 0 0 1 0 2z"></path></svg></span>
            <h1 className=' text-black text-[18px]'>Forms</h1>
            </a>
      </div>
      <div className=" flex justify-between items-center px-7 mt-5">
            <a href="/" className=' flex items-center mt-2'>
            <span className=' text-2xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><path fill='black' d="M21,22H3a.99974.99974,0,0,1-1-1V3A.99974.99974,0,0,1,3,2H21a.99974.99974,0,0,1,1,1V21A.99974.99974,0,0,1,21,22ZM4,20H20V4H4Z"></path><path fill='black' d="M9 22a.99974.99974 0 0 1-1-1V3a1 1 0 0 1 2 0V21A.99974.99974 0 0 1 9 22zM15 22a.99974.99974 0 0 1-1-1V3a1 1 0 0 1 2 0V21A.99974.99974 0 0 1 15 22z"></path><path fill='black' d="M21 10H3A1 1 0 0 1 3 8H21a1 1 0 0 1 0 2zM21 16H3a1 1 0 0 1 0-2H21a1 1 0 0 1 0 2z"></path></svg></span>
      ...
      <div className=" flex justify-between items-center px-7 mt-5">
            <a href="/" className=' flex items-center mt-2'>
            <span className=' text-2xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><path fill='rgb(6 95 70)' d="M12,12V2A10,10,0,0,1,22,12Z"></path><path fill='#ffffff' d="M12,12l5,8.66022A10.01081,10.01081,0,0,0,22,12Z"></path><path fill='black' d="M17,20.66022,12,12V2a10,10,0,1,0,5.00085,18.66168l.00336-.00427Z"></path></svg></span>
      ...
      <div className=" flex justify-between items-center px-7 mt-5">
            <a href="/" className=' flex items-center mt-2'>
            <span className=' text-2xl mr-2' ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="1em"><path fill='white' d="M15,11H13V9a1,1,0,0,0-2,0v2H9a1,1,0,0,0,0,2h2v2a1,1,0,0,0,2,0V13h2a1,1,0,0,0,0-2Z"></path><path fill='#000000' d="M12,2A10.00082,10.00082,0,0,0,4.25684,18.3291L2.293,20.293A.99991.99991,0,0,0,3,22h9A10,10,0,0,0,12,2Zm3,11H13v2a1,1,0,0,1-2,0V13H9a1,1,0,0,1,0-2h2V9a1,1,0,0,1,2,0v2h2a1,1,0,0,1,0,2Z"></path></svg></span>
